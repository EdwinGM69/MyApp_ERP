...
*/
  ...
  if (desc.includes('movimientos') || desc.includes('almacen')) return 'inventory_2'
  ...
  if (desc.includes('maestros')) return 'list_alt'
  if (desc.includes('historial') || desc.includes('transacciones')) return 'receipt_long'
